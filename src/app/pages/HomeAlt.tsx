    ...
    <>
      ...
      <section className="lpg-pad" style={{ minHeight: "82vh", position: "relative", overflow: "hidden", background: B1, display: "flex", flexDirection: "column", justifyContent: "flex-end", paddingLeft: 48, paddingRight: 48, paddingBottom: 64 }}>
        ...
        <div className="hidden md:flex" style={{ position: "absolute", top: 68, right: 48, alignItems: "center", gap: 16 }}>
          ...
          <Link to="/" style={{ fontFamily: FONT, fontWeight: 700, fontSize: 10, letterSpacing: "0.14em", textTransform: "uppercase", color: B0, backgroundColor: GREEN, padding: "6px 12px", textDecoration: "none" }}>Ver diseño 1 →</Link>
        </div>
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-[80px]" style={{ alignItems: "start" }}>
            ...
            <div>
              ...
              {[
                ...
                <div key={label} style={{ borderTop: `1px solid ${B3}66`, paddingTop: 21, paddingBottom: 21 }}>
