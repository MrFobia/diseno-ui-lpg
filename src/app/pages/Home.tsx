...
const SVCS = [
  { num: "01", title: "ASUNTOS PÚBLICOS",    tags: ["Relacionamiento", "Gremios", "Congreso", "Lobby"],       href: "/servicios/asuntos-publicos" },
  { num: "02", title: "COMUNICACIONES",       tags: ["Reputación", "Media Training", "Crisis PR", "Prensa"],    href: "/servicios/comunicaciones" },
...
export default function Home() {
  ...
  const logos = [imgImage7, imgImage8, imgImage10, imgImage11, imgImage12, imgImage13];
        ...
        <div style={{ maxWidth: 1440, width: "100%", margin: "0 auto", paddingTop: 120 }}>
          ...
          <div style={{ marginTop: 60, borderTop: `1px solid ${W08}`, paddingTop: 28, display: "flex", alignItems: "flex-end", justifyContent: "space-between", flexWrap: "wrap", gap: 24 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
              <span style={{ fontFamily: FONT, fontWeight: 400, fontSize: 10, letterSpacing: "0.22em", textTransform: "uppercase", color: W40, opacity: 0.5 }}>Síguenos</span>
              <div style={{ width: 24, height: 1, backgroundColor: W08 }} />
              {[
                {
                  label: "LinkedIn", url: "https://linkedin.com/company/libretapersonal",
                  icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>,
                },
                {
                  label: "Instagram", url: "https://instagram.com/libretapersonal",
                ...
                <a
                  ...
                  onMouseEnter={e => {
                    ...
                    e.currentTarget.style.borderColor = `${W}44`;
                    e.currentTarget.style.backgroundColor = `${W}08`;
                  }}
                  onMouseLeave={e => {
            ...
            <div>
              ...
              <div style={{ borderTop: "1px solid rgba(0,0,0,0.08)", paddingTop: 48, display: "grid", gridTemplateColumns: "1fr 1fr", rowGap: 40, columnGap: 24 }}>
                {[
                  ...
                  { n: "3",    l: "Ciudades: Cali · Bogotá · Medellín" },
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-[80px]" style={{ alignItems: "start" }}>
            ...
            <div>
              ...
              {[
                ...
                { label: "CIUDADES", value: "Cali · Bogotá · Medellín" },
              ].map(({ label, value }) => (
